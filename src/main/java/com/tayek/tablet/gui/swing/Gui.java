...
public class Gui implements Observer,ActionListener {
    ...
    static void startGui(Tablet tablet) {
        try {
            ...
            System.out.println("start gui id is ="+tablet.group.model.serialNumber);
            tablet.group.model.addObserver(gui);
            // tablet.group.model.addObserver(ModelObserver.instance);
            gui.start();
    ...
    public static void main(String[] arguments) throws IOException,InterruptedException {
        ...
        if(true) {
            Map<Integer,String> map=Group.tabletsTwoFiresAndOneJavaOnLinksys42;
            ...
            Map<Integer,String> map=Group.tabletsTwoOnLinksys42;
            for(Integer tabletId:map.keySet()) {
                Group group=new Group(1,map);
                Tablet tablet=new Tablet(group,tabletId);
                tablets.add(tablet);
                tablet.start();
